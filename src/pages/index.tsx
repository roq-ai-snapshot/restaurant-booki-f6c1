  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine v3 - Streamlining your dining experience by simplifying table reservations and menu management for a seamless restaurant visit."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine v3 - Streamlining your dining experience by simplifying table reservations and menu management for a seamless restaurant visit.`}
            </Text>
            <Box
